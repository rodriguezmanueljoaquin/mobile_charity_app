    ...
    return _then(_value.copyWith(
      ...
      phoneNumber: freezed == phoneNumber
          ...
          : phoneNumber // ignore: cast_nullable_to_non_nullable
              as String?,
      currentVolunteeringId: freezed == currentVolunteeringId
          ? _value.currentVolunteeringId
          : currentVolunteeringId // ignore: cast_nullable_to_non_nullable
              as String?,
      favoriteVolunteeringsIds: freezed == favoriteVolunteeringsIds
...
class _$_UserModel with DiagnosticableTreeMixin implements _UserModel {
  ...
  final List<String>? _favoriteVolunteeringsIds;
  @override
  List<String>? get favoriteVolunteeringsIds {
    final value = _favoriteVolunteeringsIds;
    if (value == null) return null;
    if (_favoriteVolunteeringsIds is EqualUnmodifiableListView)
      return _favoriteVolunteeringsIds;
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserModel(firstName: $firstName, lastName: $lastName, email: $email, id: $id, avatarURL: $avatarURL, gender: $gender, birthDate: $birthDate, phoneNumber: $phoneNumber, currentVolunteeringId: $currentVolunteeringId, favoriteVolunteeringsIds: $favoriteVolunteeringsIds)';
  }
