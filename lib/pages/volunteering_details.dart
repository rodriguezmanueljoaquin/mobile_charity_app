...
class VolunteeringDetailsPage extends StatefulWidget {
  final String id;
  ...
  @override
  State<VolunteeringDetailsPage> createState() =>
      _VolunteeringDetailsPageState();
}

class _VolunteeringDetailsPageState extends State<VolunteeringDetailsPage> {
    ...
    return SerManosScaffold(
      ...
      body: Column(
        children: [
          ...
          SizedBox(
            width: SerManosSizes.sizeLG,
            child: widget.userVolunteeringId != null &&
                    widget.userVolunteeringId == volunteering.id
                ? Column(
                    children: [
                ...
                : Column(
                    children: [
                      if (widget.userVolunteeringId != null &&
                          widget.userVolunteeringId != volunteering.id)
                        Column(
                          children: [
                            const SerManosSizedBox.md(),
                      ...
                      SerManosTextButton.longTextButton(
                        ...
                        disabled: volunteering.vacancies == 0 ||
                            widget.userVolunteeringId != null,
                        onPressed: _showDialog(
                            context: context,
                            title: enlistTitle,
                            volunteeringTitle: volunteering.title),
